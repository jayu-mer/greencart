...
const AddAddress = () => {
  const [address, setAddress] = useState({
    firstName: '',
    lastName: '',   // ✅ Fixed typo from lastNmae to lastName
    email: '',
    street: '',
    city: '',
    state: '',      // ✅ Use lowercase 'state'
    zipcode: '',
    country: '',
    phone: '',
  });
  ...
  const handleChange = (e) => {
    ...
    setAddress((prevAddress) => ({
      ...prevAddress,     // ✅ Fixed incorrect spread of AddAddress
      [name]: value,
    }));
  };
  ...
  const onsubmitHandler = async (e) => {
    e.preventDefault();
    // You can now send `address` to your backend or use it elsewhere
